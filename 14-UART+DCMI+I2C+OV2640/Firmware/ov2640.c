...
const unsigned char OV2640_JPEG_INIT[][2] = {
    ...
    {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x00}, {0x5a, 0xC8}, {0x5b, 0x96}, {0x5c, 0x00}, {0xd3, 0x00}, {0xc3, 0xed},
    {0x7f, 0x00}, {0xda, 0x00}, {0xe5, 0x1f}, {0xe1, 0x67}, {0xe0, 0x00}, {0xdd, 0x7f}, {0x05, 0x00}, {0x12, 0x40},
    {0xd3, 0x04}, {0xc0, 0x16}, {0xC1, 0x12}, {0x8c, 0x00}, {0x86, 0x3d}, {0x50, 0x00}, {0x51, 0x2C}, {0x52, 0x24},
    {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x00}, {0x5A, 0x2c}, {0x5b, 0x24}, {0x5c, 0x00}, {0xff, 0xff},
};
...
const unsigned char OV2640_160x120_JPEG[][2] = {
    ...
    {0x54, 0x00}, {0x55, 0x00}, {0x57, 0x00}, {0x5a, 0x2c}, {0x5b, 0x24}, {0x5c, 0x00}, {0xe0, 0x00}, {0xff, 0xff}};
...
const unsigned char OV2640_640x480_JPEG[][2] = {
    {0xff, 0x01}, {0x11, 0x01}, {0x12, 0x00}, {0x17, 0x11}, {0x18, 0x75}, {0x32, 0x36}, {0x19, 0x01},
    {0x1a, 0x97}, {0x03, 0x0f}, {0x37, 0x40}, {0x4f, 0xbb}, {0x50, 0x9c}, {0x5a, 0x57}, {0x6d, 0x80},
    {0x3d, 0x34}, {0x39, 0x02}, {0x35, 0x88}, {0x22, 0x0a}, {0x37, 0x40}, {0x34, 0xa0}, {0x06, 0x02},
    {0x0d, 0xb7}, {0x0e, 0x01}, {0xff, 0x00}, {0xe0, 0x04}, {0xc0, 0xc8}, {0xc1, 0x96}, {0x86, 0x3d},
    {0x50, 0x89}, {0x51, 0x90}, {0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x57, 0x00},
    {0x5a, 0xa0}, {0x5b, 0x78}, {0x5c, 0x00}, {0xd3, 0x04}, {0xe0, 0x00}, {0xff, 0xff},
};
...
const unsigned char OV2640_800x600_JPEG[][2] = {
    ...
    {0x1a, 0x97}, {0x03, 0x0f}, {0x37, 0x40}, {0x4f, 0xbb}, {0x50, 0x9c}, {0x5a, 0x57}, {0x6d, 0x80},
    {0x3d, 0x34}, {0x39, 0x02}, {0x35, 0x88}, {0x22, 0x0a}, {0x37, 0x40}, {0x34, 0xa0}, {0x06, 0x02},
    {0x0d, 0xb7}, {0x0e, 0x01}, {0xFF, 0x00}, {0xe0, 0x04}, {0xc0, 0xc8}, {0xc1, 0x96}, {0x86, 0x35},
    {0x50, 0x89}, {0x51, 0x90}, {0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x57, 0x00},
    {0x5a, 0xc8}, {0x5b, 0x96}, {0x5c, 0x00}, {0xd3, 0x02}, {0xe0, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_1024x768_JPEG[][2] = {
    {0xFF, 0x01}, {0x11, 0x01}, {0x12, 0x00}, {0x17, 0x11}, {0x18, 0x75}, {0x32, 0x36}, {0x19, 0x01}, {0x1a, 0x97},
    {0x03, 0x0f}, {0x37, 0x40}, {0x4f, 0xbb}, {0x50, 0x9c}, {0x5a, 0x57}, {0x6d, 0x80}, {0x3d, 0x34}, {0x39, 0x02},
    {0x35, 0x88}, {0x22, 0x0a}, {0x37, 0x40}, {0x34, 0xa0}, {0x06, 0x02}, {0x0d, 0xb7}, {0x0e, 0x01}, {0xFF, 0x00},
    {0xc0, 0xC8}, {0xc1, 0x96}, {0x8c, 0x00}, {0x86, 0x3D}, {0x50, 0x00}, {0x51, 0x90}, {0x52, 0x2C}, {0x53, 0x00},
    {0x54, 0x00}, {0x55, 0x88}, {0x5a, 0x00}, {0x5b, 0xC0}, {0x5c, 0x01}, {0xd3, 0x02}, {0xff, 0xff}};
...
const unsigned char OV2640_1280x960_JPEG[][2] = {
    ...
    {0x3d, 0x34}, {0x39, 0x02}, {0x35, 0x88}, {0x22, 0x0a}, {0x37, 0x40}, {0x34, 0xa0}, {0x06, 0x02},
    {0x0d, 0xb7}, {0x0e, 0x01}, {0xFF, 0x00}, {0xe0, 0x04}, {0xc0, 0xc8}, {0xc1, 0x96}, {0x86, 0x3d},
    {0x50, 0x00}, {0x51, 0x90}, {0x52, 0x2c}, {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x88}, {0x57, 0x00},
    {0x5a, 0x40}, {0x5b, 0xf0}, {0x5c, 0x01}, {0xd3, 0x02}, {0xe0, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_CONTRAST2[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x07}, {0x7d, 0x20},
                                             {0x7d, 0x28}, {0x7d, 0x0c}, {0x7d, 0x06}, {0xff, 0xff}};

const unsigned char OV2640_CONTRAST1[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x07}, {0x7d, 0x20},
                                             {0x7d, 0x24}, {0x7d, 0x16}, {0x7d, 0x06}, {0xff, 0xff}};

const unsigned char OV2640_CONTRAST0[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x07}, {0x7d, 0x20},
                                             {0x7d, 0x20}, {0x7d, 0x20}, {0x7d, 0x06}, {0xff, 0xff}};

const unsigned char OV2640_CONTRAST_1[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x07}, {0x7d, 0x20},
                                              {0x7d, 0x1c}, {0x7d, 0x2a}, {0x7d, 0x06}, {0xff, 0xff}};

const unsigned char OV2640_CONTRAST_2[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x07}, {0x7d, 0x20},
                                              {0x7d, 0x18}, {0x7d, 0x34}, {0x7d, 0x06}, {0xff, 0xff}};

const unsigned char OV2640_SATURATION2[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x02}, {0x7c, 0x03},
                                               {0x7d, 0x68}, {0x7d, 0x68}, {0xff, 0xff}};

const unsigned char OV2640_SATURATION1[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x02}, {0x7c, 0x03},
                                               {0x7d, 0x58}, {0x7d, 0x68}, {0xff, 0xff}};

const unsigned char OV2640_SATURATION0[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x02}, {0x7c, 0x03},
                                               {0x7d, 0x48}, {0x7d, 0x48}, {0xff, 0xff}};

const unsigned char OV2640_SATURATION_1[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x02}, {0x7c, 0x03},
                                                {0x7d, 0x38}, {0x7d, 0x38}, {0xff, 0xff}};

const unsigned char OV2640_SATURATION_2[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x02}, {0x7c, 0x03},
                                                {0x7d, 0x28}, {0x7d, 0x28}, {0xff, 0xff}};

const unsigned char OV2640_BRIGHTNESS2[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x09},
                                               {0x7d, 0x40}, {0x7d, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_BRIGHTNESS1[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x09},
                                               {0x7d, 0x30}, {0x7d, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_BRIGHTNESS0[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x09},
                                               {0x7d, 0x20}, {0x7d, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_BRIGHTNESS_1[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x09},
                                                {0x7d, 0x10}, {0x7d, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_BRIGHTNESS_2[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x04}, {0x7c, 0x09},
                                                {0x7d, 0x00}, {0x7d, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_SPECIAL_EFFECTS_NORMAL[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x00}, {0x7c, 0x05},
                                                          {0x7d, 0x80}, {0x7d, 0x80}, {0xff, 0xff}};

const unsigned char OV2640_SPECIAL_EFFECTS_ANTIQUE[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x18}, {0x7c, 0x05},
...
const unsigned char OV2640_SPECIAL_EFFECTS_BLUISH[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x18}, {0x7c, 0x05},
                                                          {0x7d, 0xa0}, {0x7d, 0x40}, {0xff, 0xff}};

const unsigned char OV2640_SPECIAL_EFFECTS_BLACK[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x18}, {0x7c, 0x05},
                                                         {0x7d, 0x80}, {0x7d, 0x80}, {0xff, 0xff}};

const unsigned char OV2640_SPECIAL_EFFECTS_NEGATIVE[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x40}, {0x7c, 0x05},
                                                            {0x7d, 0x80}, {0x7d, 0x80}, {0xff, 0xff}};

const unsigned char OV2640_SPECIAL_EFFECTS_GREENISH[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x18}, {0x7c, 0x05},
                                                            {0x7d, 0x40}, {0x7d, 0x40}, {0xff, 0xff}};

const unsigned char OV2640_SPECIAL_EFFECTS_REDDISH[][2] = {{0xff, 0x00}, {0x7c, 0x00}, {0x7d, 0x18}, {0x7c, 0x05},
                                                           {0x7d, 0x40}, {0x7d, 0xc0}, {0xff, 0xff}};

const unsigned char OV2640_LIGHT_MODE_AUTO[][2] = {{0xff, 0x00}, {0xc7, 0x00}, {0xff, 0xff}};

const unsigned char OV2640_LIGHT_MODE_SUNNY[][2] = {{0xff, 0x00}, {0xc7, 0x40}, {0xcc, 0x5e},
                                                    {0xcd, 0x41}, {0xce, 0x54}, {0xff, 0xff}};

const unsigned char OV2640_LIGHT_MODE_CLOUDY[][2] = {{0xff, 0x00}, {0xc7, 0x40}, {0xcc, 0x65},
                                                     {0xcd, 0x41}, {0xce, 0x4f}, {0xff, 0xff}};

const unsigned char OV2640_LIGHT_MODE_OFFICE[][2] = {{0xff, 0x00}, {0xc7, 0x40}, {0xcc, 0x52},
                                                     {0xcd, 0x41}, {0xce, 0x66}, {0xff, 0xff}};

const unsigned char OV2640_LIGHT_MODE_HOME[][2] = {{0xff, 0x00}, {0xc7, 0x40}, {0xcc, 0x42},
...
short SCCB_Write(uint8_t reg_addr, uint8_t data)
{
    ...
    buffer[1] = data;
    __disable_irq();
    connectionStatus = HAL_I2C_Master_Transmit(phi2c, 0xc0, buffer, 2, 100);
...
short SCCB_Read(uint8_t reg_addr, uint8_t *pdata)
{
    ...
    HAL_StatusTypeDef connectionStatus;
    __disable_irq();
    connectionStatus = HAL_I2C_Master_Transmit(phi2c, 0xc0, &reg_addr, 1, 100);
    if (connectionStatus == HAL_OK)
    {
        connectionStatus = HAL_I2C_Master_Receive(phi2c, (uint16_t)0xc2, pdata, 1, 100);
        if (connectionStatus == HAL_OK)
        {
            opertionStatus = 0;
        }
